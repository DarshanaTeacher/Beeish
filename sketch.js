...
function setup() 
{
  ...
  //create bee
  bee = createSprite(windowWidth/2,windowHeight-100,50,50);
  ...
  //create wing
  wing = createSprite(windowWidth/2,windowHeight-50,windowWidth,10);
  wing.visible = false;
...
function draw() 
{
  ...
  fill("red");
  textSize(18);
  text("Collect Honey From 10 Flowers",100,100);
  text("HONEY IN HIVE : "+honey+"%" ,100,50);
